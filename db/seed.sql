...
--
-- 실행:  psql -U <user> -d <db> -f db/seed.sql   (schema.sql 실행 후)
--
...
-- 권한
-- ---------------------------------------------------------------------
INSERT INTO TBL_SYS_AUTH (AUTH_ID, AUTH_NM, USE_YN, FRST_REGR_EMPNO, LST_CHGR_EMPNO) VALUES
...
-- ---------------------------------------------------------------------
INSERT INTO TBL_SYS_USER (USER_ID, USER_NM, USER_PWD, USER_EML, USE_YN, APR_YN, APR_ID, FRST_REGR_EMPNO, LST_CHGR_EMPNO) VALUES
...
INSERT INTO TBL_SYS_USER_AUTH (USER_ID, AUTH_ID, FRST_REGR_EMPNO, LST_CHGR_EMPNO) VALUES
...
-- 프로그램 (화면 경로)
-- ---------------------------------------------------------------------
INSERT INTO TBL_SYS_PGM (PGM_ID, PGM_NM, PGM_PTH_NM, FRST_REGR_EMPNO, LST_CHGR_EMPNO) VALUES
...
-- 메뉴 (1단계: 대분류)
-- ---------------------------------------------------------------------
INSERT INTO TBL_SYS_MENU (MENU_ID, MENU_NM, UPPO_MENU_ID, PGM_ID, MENU_STEP, MENU_SEQO, USE_YN, FRST_REGR_EMPNO, LST_CHGR_EMPNO) VALUES
...
SELECT 'PRIVACY', '<p>개인정보처리방침 본문을 입력해 주세요.</p>', 'Y', 'system'
 WHERE NOT EXISTS (SELECT 1 FROM TBL_HP_TERM WHERE TERM_KND_CD = 'PRIVACY');

INSERT INTO TBL_HP_TERM (TERM_KND_CD, TERM_CTT, USE_YN, LST_CHGR_EMPNO)
SELECT 'EMAIL', '<p>이메일무단수집거부 본문을 입력해 주세요.</p>', 'Y', 'system'
